...
export default function Hero() {
  return (
    <section className='bg-light-300 flex min-h-screen justify-center lg:min-h-0'>
      <div className='absolute flex h-screen w-full items-center justify-center lg:relative lg:aspect-2/1 lg:h-fit xl:container xl:w-9/10 xl:items-end xl:justify-start xl:p-20'>
        <Image
          className='raised-500 lg:raised-700 object-cover object-center xl:rounded-b-4xl'
          fill
          src={data.image.src}
          alt={data.image.alt}
        />
