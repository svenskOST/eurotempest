...
export default function CarouselCard({ icon: Icon, title, description, button }) {
  return (
    <motion.div
      className='flex w-full max-w-sm md:max-w-[26rem] px-8 flex-col items-center bg-linear-65 from-dark-600 to-blue-950/50 text-light-200 rounded-lg gap-8 py-16 shadow-lg/30 hover:scale-105 hover:shadow-xl/30 transition-[box-shadow,_scale] md:max-lg:h-[31rem]'
